...
//NOTE: the user does not need to see all the functions that call opengl. it wouldnt do anything, since the gl instance is bound to the render thread.
...
MG_API int MG_shader_status(MG_SHADER shader_id);
...
MG_API MG_Material* MG_material_ptr(MG_MATERIAL material_id);
