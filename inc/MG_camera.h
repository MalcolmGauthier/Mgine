...
MG_API MG_Matrix MG_camera_get_view_matrix(MG_GameData* camera);

MG_API MG_Vec3 MG_camera_get_world_position(MG_GameData* game_data);
MG_API MG_Vec3 MG_camera_get_world_rotation(MG_GameData* game_data);
