...
MG_API MG_OBJ MG_object_create(MG_Instance* instance, MG_OBJ parent, const char* name, MG_ObjectFlags flags);
...
MG_API MG_OBJ MG_object_create_with_parent(MG_Object* parent_object, const char* name, MG_ObjectFlags flags);
...
MG_API MG_Object* MG_object_get_ptr(MG_Instance* instance, MG_OBJ id);
MG_API MG_Object* MG_object_get_ptr_by_name(MG_Instance* instance, const char* name);
// returns a pointer to the linked list of all objects. use not recommended.
//TODO: change to be a copy
MG_API MG_OBJ_ARRAY MG_object_get_all(MG_Instance* instance);
// returns a linked list of all top-level objects (objects without a parent)
MG_API MG_OBJ_ARRAY MG_object_get_all_top_level(MG_Instance* instance);
MG_API MG_OBJ_ARRAY MG_object_get_all_with_flags(MG_Instance* instance, MG_ObjectFlags flags);
MG_API MG_OBJ_ARRAY MG_object_get_all_with_component(MG_Instance* instance, MG_ID type);
MG_API MG_OBJ_ARRAY MG_object_get_all_with_component_flags(MG_Instance* instance, MG_ObjectFlags flags);
...
MG_API MG_Component* MG_object_get_component_by_id(MG_OBJ object, MG_ID component_id);
...
MG_API int MG_object_delete(MG_Instance* instance, MG_OBJ object);
// returns void for compatibility with LL functions
MG_API void MG_object_delete_by_ptr(MG_Object* object);
MG_API int MG_object_delete_non_recursive(MG_Instance* instance, MG_OBJ object);
