...
typedef struct MG_LinkedList
{
    void* data;
    struct MG_LinkedList* next;
}
MG_LinkedList;
...
MG_API int MG_LL_add(MG_LinkedList** head_ptr, void* value);
...
// returns null on failure or failure to find data, otherwise returns find.
MG_API void* MG_LL_remove(MG_LinkedList** head_ptr, void* find);
...
MG_API void* MG_LL_find(MG_LinkedList* head, void* find);
...
MG_API void* MG_LL_find_func(MG_LinkedList* head, void* find, bool (*find_func)(void* data, void* find));
...
MG_API MG_LinkedList* MG_LL_copy(MG_LinkedList* head, void* (*copy_func)(void* source));
...
MG_API void MG_LL_free(MG_LinkedList** head_ptr, void (*free_func)(void* data));
// frees the linked list without freeing the data pointers.
MG_API void MG_LL_free_LL_only(MG_LinkedList** head_ptr);
